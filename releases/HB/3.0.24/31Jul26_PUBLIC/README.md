...
Generated on: 07/31/2026 11:44:24
...
`provision -Version "3.0.24" -Release "31Jul26" -Model "HB" -Mode "Public" -Wipe -Firmware`

To generate the binaries in THIS folder, run:
`provision -Version "3.0.24" -Release "31Jul26" -Model "HB" -Mode "Public" -Archive`

To generate the binaries and OTA files in THIS folder in one step, run:
`provision -Version "3.0.24" -Release "31Jul26" -Model "HB" -Mode "Public" -Archive -OTA`
...
`release -Version "3.0.24" -Release "31Jul26" -Model "HB" -Mode "Public"`
