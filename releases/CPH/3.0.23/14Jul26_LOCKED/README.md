...
# Version: 3.0.23 | Release: 14Jul26 | Mode: Locked
Generated on: 07/15/2026 11:21:13
...
`provision -Version "3.0.23" -Release "14Jul26" -Model "CPH" -Mode "Locked" -Wipe -Firmware`

To generate the binaries in THIS folder, run:
`provision -Version "3.0.23" -Release "14Jul26" -Model "CPH" -Mode "Locked" -Archive`

To generate the binaries and OTA files in THIS folder in one step, run:
`provision -Version "3.0.23" -Release "14Jul26" -Model "CPH" -Mode "Locked" -Archive -OTA`
...
`release -Version "3.0.23" -Release "14Jul26" -Model "CPH" -Mode "Locked"`
