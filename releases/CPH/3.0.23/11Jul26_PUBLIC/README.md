...
# Version: 3.0.23 | Release: 11Jul26 | Mode: Public
Generated on: 07/12/2026 10:16:48
...
`provision -Version "3.0.23" -Release "11Jul26" -Model "CPH" -Mode "Public" -Wipe -Firmware`

To generate the binaries in THIS folder, run:
`provision -Version "3.0.23" -Release "11Jul26" -Model "CPH" -Mode "Public" -Archive`

To generate the binaries and OTA files in THIS folder in one step, run:
`provision -Version "3.0.23" -Release "11Jul26" -Model "CPH" -Mode "Public" -Archive -OTA`
...
`release -Version "3.0.23" -Release "11Jul26" -Model "CPH" -Mode "Public"`
