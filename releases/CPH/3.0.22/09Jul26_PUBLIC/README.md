...
Generated on: 07/10/2026 13:15:46
...
`provision -Version "3.0.22" -Release "09Jul26" -Model "CPH" -Mode "Public" -Wipe -Firmware`

To generate the binaries in THIS folder, run:
`provision -Version "3.0.22" -Release "09Jul26" -Model "CPH" -Mode "Public" -Archive`

To generate the binaries and OTA files in THIS folder in one step, run:
`provision -Version "3.0.22" -Release "09Jul26" -Model "CPH" -Mode "Public" -Archive -OTA`
...
`release -Version "3.0.22" -Release "09Jul26" -Model "CPH" -Mode "Public"`
