...
# Version: 3.0.24 | Release: 31Jul26 | Mode: Public
Generated on: 07/31/2026 11:40:18
...
`provision -Version "3.0.24" -Release "31Jul26" -Model "CPH" -Mode "Public" -Wipe -Firmware`

To generate the binaries in THIS folder, run:
`provision -Version "3.0.24" -Release "31Jul26" -Model "CPH" -Mode "Public" -Archive`

To generate the binaries and OTA files in THIS folder in one step, run:
`provision -Version "3.0.24" -Release "31Jul26" -Model "CPH" -Mode "Public" -Archive -OTA`
...
`release -Version "3.0.24" -Release "31Jul26" -Model "CPH" -Mode "Public"`
