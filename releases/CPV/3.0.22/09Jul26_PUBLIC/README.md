...
Generated on: 07/10/2026 15:13:50
...
`provision -Version "3.0.22" -Release "09Jul26" -Model "CPV" -Mode "Public" -Wipe -Firmware`

To generate the binaries in THIS folder, run:
`provision -Version "3.0.22" -Release "09Jul26" -Model "CPV" -Mode "Public" -Archive`

To generate the binaries and OTA files in THIS folder in one step, run:
`provision -Version "3.0.22" -Release "09Jul26" -Model "CPV" -Mode "Public" -Archive -OTA`
...
`release -Version "3.0.22" -Release "09Jul26" -Model "CPV" -Mode "Public"`
