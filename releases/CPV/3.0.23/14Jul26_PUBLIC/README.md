...
# Version: 3.0.23 | Release: 14Jul26 | Mode: Public
Generated on: 07/15/2026 11:16:44
...
`provision -Version "3.0.23" -Release "14Jul26" -Model "CPV" -Mode "Public" -Wipe -Firmware`

To generate the binaries in THIS folder, run:
`provision -Version "3.0.23" -Release "14Jul26" -Model "CPV" -Mode "Public" -Archive`

To generate the binaries and OTA files in THIS folder in one step, run:
`provision -Version "3.0.23" -Release "14Jul26" -Model "CPV" -Mode "Public" -Archive -OTA`
...
`release -Version "3.0.23" -Release "14Jul26" -Model "CPV" -Mode "Public"`
