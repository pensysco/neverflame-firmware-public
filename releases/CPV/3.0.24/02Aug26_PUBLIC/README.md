...
# Version: 3.0.24 | Release: 02Aug26 | Mode: Public
Generated on: 08/02/2026 19:54:21
...
`provision -Version "3.0.24" -Release "02Aug26" -Model "CPV" -Mode "Public" -Wipe -Firmware`

To generate the binaries in THIS folder, run:
`provision -Version "3.0.24" -Release "02Aug26" -Model "CPV" -Mode "Public" -Archive`

To generate the binaries and OTA files in THIS folder in one step, run:
`provision -Version "3.0.24" -Release "02Aug26" -Model "CPV" -Mode "Public" -Archive -OTA`
...
`release -Version "3.0.24" -Release "02Aug26" -Model "CPV" -Mode "Public"`
